...
extension Login: UITextFieldDelegate {
    ...
    func handelTF() {
        ...
        phoneNumber.attributedPlaceholder = NSAttributedString(string: "PhoneNumber", attributes: attributes)
        TF.handelTFSpace(textfeild: phoneNumber)
        ...
        TF.handelTFSpace(textfeild: password)
    }
    // MARK: - handel text  field extention
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if (textField == phoneNumber) {
            phoneNumberView.backgroundColor = UIColor(named: "First")
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        if (textField == phoneNumber) {
            phoneNumberView.backgroundColor = UIColor(named: "TF")
        } else if (textField == password) {
